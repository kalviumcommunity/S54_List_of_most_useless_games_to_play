...
export default function CardDetailed() {
  ...
  useEffect(() => {
    axios
      .get(`https://asap-project.onrender.com/post/${id}`)
      .then((res) => {
  ...
  const deletePost = () => {
    ...
    if (result) {
      axios
        .delete(`https://asap-project.onrender.com/post/${id}`)
        .then((res) => {
          navigate("/list");
        })
        .catch((err) => {
  ...
  return (
    <div className="det-card">
      ...
      <div className="det-button">
        <text onClick={editPost} className="button_Edit">
          Edit
        </text>
        <text onClick={deletePost} className="button_Edit">
          Delete
        </text>
        <text onClick={back} className="button_Edit">
          Back
        </text>
      </div>
    </div>
